...
/* Copiado de: https://stackoverflow.com/a/6446790 */
 ...
 */
public class SpanishArrayAdapter<T> extends BaseAdapter implements Filterable {
    /**
     ...
     *                           instantiating views.
     */
    public SpanishArrayAdapter(Context context, int textViewResourceId) {
     ...
     */
    public SpanishArrayAdapter(Context context, int resource, int textViewResourceId) {
     ...
     */
    public SpanishArrayAdapter(Context context, int textViewResourceId, T[] objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public SpanishArrayAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public SpanishArrayAdapter(Context context, int textViewResourceId, List<T> objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public SpanishArrayAdapter(Context context, int resource, int textViewResourceId, List<T> objects) {
     ...
     */
    public static SpanishArrayAdapter<CharSequence> createFromResource(Context context,
                                                                       int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new SpanishArrayAdapter<CharSequence>(context, textViewResId, strings);
    }
    ...
    private class HRArrayFilter extends Filter {
        ...
        private String toNoPalatals(String original) {
            ...
            // https://www1.icsi.berkeley.edu/~chema/espanol/caracteres_hispanos.html
